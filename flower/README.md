...
<a href="../merkaba/vr/FlowerOfLifeMerkaba2.htm" target="_blank" title="3D model" class="fotoA"><img src="../merkaba/ar/199A.png" class="foto" alt="Flower of Life in Merkaba symbol"></a>
...
<a href="../merkaba/vr/FlowerOfLifeMerkaba3.htm" target="_blank" title="3D model" class="fotoA"><img src="../merkaba/ar/198A.png" class="foto" alt="Flower of Life in Merkaba symbol"></a>
 <br><br><br><br>In this representation we have the Flower of Life symbol in Merkaba 3D symbol. The Merkabah or Star tetrahedron or Star of Davi is the geometric figure that represents male and female energy  Heaven and Earth. The Star tetrahedron corresponds to the sixth circumference of the Seed of Life symbol and the vertices of this solid appear overlapping with some circumferences of the Flower of Life symbol.
 <br><br><br><br>
 <hr>
<h4>13. Flower of Life in Merkaba symbol v3</h4>
<a href="../merkaba/vr/FlowerOfLifeMerkaba4.htm" target="_blank" title="3D model" class="fotoA"><img src="../merkaba/ar/197A.png" class="foto" alt="Flower of Life in Merkaba symbol"></a>
 <br><br><br><br>In this representation we have the Flower of Life symbol in Merkaba 3D symbol. The Merkabah or Star tetrahedron or Star of Davi is the geometric figure that represents male and female energy  Heaven and Earth. The Star tetrahedron corresponds to the sixth circumference of the Seed of Life symbol and the vertices of this solid appear overlapping with some circumferences of the Flower of Life symbol.
 <br><br><br><br>
 <hr>
...
<a href="../grid/vr/GridOfLife_FlowerofLife1.htm" target="_blank" title="3D model" class="fotoA"><img src="../grid/ar/295A.png" class="foto" alt="Grid of life with Flower of life symbol"></a>
 <br><br><br><br><br>The Flower of Life is believed to be a key that can unlock the hidden knowledge of time and space within its petal-like structures. In this representation, we see the Flower of Life symbol forming the 3D symbol of the Grid of Life.
 <br><br><br><br><br>
 <hr>
<h4>30. Grid of life with Flower of life symbol v3</h4>
<a href="../grid/vr/GridOfLife_FlowerofLife2.htm" target="_blank" title="3D model" class="fotoA"><img src="../grid/ar/294A.png" class="foto" alt="Grid of life with Flower of life symbol"></a>
 <br><br><br><br><br>The Flower of Life is believed to be a key that can unlock the hidden knowledge of time and space within its petal-like structures. In this representation, we see the Flower of Life symbol forming the 3D symbol of the Grid of Life.
 <br><br><br><br><br>
 <hr>
 <p class="topop"><a href="#p1" class="topo">back to top</a></p>
<h4>31. Grid of life with Flower of life symbol v4</h4>
<a href="../grid/vr/GridOfLife_FlowerofLife3.htm" target="_blank" title="3D model" class="fotoA"><img src="../grid/ar/293A.png" class="foto" alt="Grid of life with Flower of life symbol"></a>
 <br><br><br><br><br>The Flower of Life is believed to be a key that can unlock the hidden knowledge of time and space within its petal-like structures. In this representation, we see the Flower of Life symbol forming the 3D symbol of the Grid of Life.
 <br><br><br><br><br>
 <hr>
...
<p>Siqueira, P.H., "Flower of life and the polyhedra of Plato and Archimedes: Visualization of symbols with Augmented Reality and Virtual Reality". Available in: <https://paulohscwb.github.io/SacredGeometry/flower/>, June 2024.</p>
